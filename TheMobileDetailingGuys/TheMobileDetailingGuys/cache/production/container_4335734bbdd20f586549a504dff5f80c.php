...
class phpbb_cache_container extends \Symfony\Component\DependencyInjection\Container
{
    ...
    {
        return $this->services['config'] = new \phpbb\config\db(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['cache.driver']) ? $this->services['cache.driver'] : ($this->services['cache.driver'] = new \phpbb\cache\driver\file())) && false ?: '_'}, 'pa7v_config');
    }
    ...
    {
        return $this->services['config_text'] = new \phpbb\config\db_text(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'pa7v_config_text');
    }
    ...
    {
        return $this->services['content.visibility'] = new \phpbb\content_visibility(${($_ = isset($this->services['auth']) ? $this->services['auth'] : ($this->services['auth'] = new \phpbb\auth\auth())) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['dispatcher']) ? $this->services['dispatcher'] : $this->getDispatcherService()) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, './', 'php', 'pa7v_forums', 'pa7v_posts', 'pa7v_topics', 'pa7v_users');
    }
    ...
    {
        $instance = new \phpbb\captcha\plugins\qa('pa7v_captcha_questions', 'pa7v_captcha_answers', 'pa7v_qa_confirm');
    ...
    {
        return $this->services['ext.manager'] = new \phpbb\extension\manager($this, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['filesystem']) ? $this->services['filesystem'] : ($this->services['filesystem'] = new \phpbb\filesystem\filesystem())) && false ?: '_'}, 'pa7v_ext', './', 'php', ${($_ = isset($this->services['cache']) ? $this->services['cache'] : $this->getCacheService()) && false ?: '_'});
    }
    ...
    {
        return new \phpbb\notification\method\email(${($_ = isset($this->services['user_loader']) ? $this->services['user_loader'] : $this->getUserLoaderService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['config']) ? $this->services['config'] : $this->getConfigService()) && false ?: '_'}, ${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, './', 'php', 'pa7v_notification_emails');
    }
    ...
    {
        $instance = new \phpbb\notification\type\admin_activate_user(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, ${($_ = isset($this->services['language']) ? $this->services['language'] : $this->getLanguageService()) && false ?: '_'}, ${($_ = isset($this->services['user']) ? $this->services['user'] : $this->getUserService()) && false ?: '_'}, ${($_ = isset($this->services['auth']) ? $this->services['auth'] : ($this->services['auth'] = new \phpbb\auth\auth())) && false ?: '_'}, './', 'php', 'pa7v_user_notifications');
    ...
    {
        return $this->services['profilefields.lang_helper'] = new \phpbb\profilefields\lang_helper(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'pa7v_profile_fields_lang');
    }
    ...
    {
        return $this->services['text_formatter.data_access'] = new \phpbb\textformatter\data_access(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'pa7v_bbcodes', 'pa7v_smilies', 'pa7v_styles', 'pa7v_words', './styles/');
    }
    ...
    {
        $this->services['text_reparser.forum_description'] = $instance = new \phpbb\textreparser\plugins\forum_description(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'pa7v_forums');
    ...
    {
        $this->services['text_reparser.forum_rules'] = $instance = new \phpbb\textreparser\plugins\forum_rules(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'pa7v_forums');
    ...
    {
        $this->services['text_reparser.group_description'] = $instance = new \phpbb\textreparser\plugins\group_description(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'pa7v_groups');
    ...
    {
        $this->services['text_reparser.pm_text'] = $instance = new \phpbb\textreparser\plugins\pm_text(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'pa7v_privmsgs');
    ...
    {
        $this->services['text_reparser.poll_option'] = $instance = new \phpbb\textreparser\plugins\poll_option(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'pa7v_poll_options');
    ...
    {
        $this->services['text_reparser.poll_title'] = $instance = new \phpbb\textreparser\plugins\poll_title(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'pa7v_topics');
    ...
    {
        $this->services['text_reparser.post_text'] = $instance = new \phpbb\textreparser\plugins\post_text(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'pa7v_posts');
    ...
    {
        $this->services['text_reparser.user_signature'] = $instance = new \phpbb\textreparser\plugins\user_signature(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, 'pa7v_users');
    ...
    {
        return $this->services['user_loader'] = new \phpbb\user_loader(${($_ = isset($this->services['dbal.conn']) ? $this->services['dbal.conn'] : ($this->services['dbal.conn'] = new \phpbb\db\driver\factory($this))) && false ?: '_'}, './', 'php', 'pa7v_users');
    }
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'tables.acl_groups' => 'pa7v_acl_groups',
            'tables.acl_options' => 'pa7v_acl_options',
            'tables.acl_roles' => 'pa7v_acl_roles',
            'tables.acl_roles_data' => 'pa7v_acl_roles_data',
            'tables.acl_users' => 'pa7v_acl_users',
            'tables.attachments' => 'pa7v_attachments',
            'tables.auth_provider_oauth_token_storage' => 'pa7v_oauth_tokens',
            'tables.auth_provider_oauth_states' => 'pa7v_oauth_states',
            'tables.auth_provider_oauth_account_assoc' => 'pa7v_oauth_accounts',
            'tables.banlist' => 'pa7v_banlist',
            'tables.bbcodes' => 'pa7v_bbcodes',
            'tables.bookmarks' => 'pa7v_bookmarks',
            'tables.bots' => 'pa7v_bots',
            'tables.captcha_qa_questions' => 'pa7v_captcha_questions',
            'tables.captcha_qa_answers' => 'pa7v_captcha_answers',
            'tables.captcha_qa_confirm' => 'pa7v_qa_confirm',
            'tables.config' => 'pa7v_config',
            'tables.config_text' => 'pa7v_config_text',
            'tables.confirm' => 'pa7v_confirm',
            'tables.disallow' => 'pa7v_disallow',
            'tables.drafts' => 'pa7v_drafts',
            'tables.ext' => 'pa7v_ext',
            'tables.extensions' => 'pa7v_extensions',
            'tables.extension_groups' => 'pa7v_extension_groups',
            'tables.forums' => 'pa7v_forums',
            'tables.forums_access' => 'pa7v_forums_access',
            'tables.forums_track' => 'pa7v_forums_track',
            'tables.forums_watch' => 'pa7v_forums_watch',
            'tables.groups' => 'pa7v_groups',
            'tables.icons' => 'pa7v_icons',
            'tables.lang' => 'pa7v_lang',
            'tables.log' => 'pa7v_log',
            'tables.login_attempts' => 'pa7v_login_attempts',
            'tables.migrations' => 'pa7v_migrations',
            'tables.moderator_cache' => 'pa7v_moderator_cache',
            'tables.modules' => 'pa7v_modules',
            'tables.notification_emails' => 'pa7v_notification_emails',
            'tables.notification_types' => 'pa7v_notification_types',
            'tables.notifications' => 'pa7v_notifications',
            'tables.poll_options' => 'pa7v_poll_options',
            'tables.poll_votes' => 'pa7v_poll_votes',
            'tables.posts' => 'pa7v_posts',
            'tables.privmsgs' => 'pa7v_privmsgs',
            'tables.privmsgs_folder' => 'pa7v_privmsgs_folder',
            'tables.privmsgs_rules' => 'pa7v_privmsgs_rules',
            'tables.privmsgs_to' => 'pa7v_privmsgs_to',
            'tables.profile_fields' => 'pa7v_profile_fields',
            'tables.profile_fields_data' => 'pa7v_profile_fields_data',
            'tables.profile_fields_options_language' => 'pa7v_profile_fields_lang',
            'tables.profile_fields_language' => 'pa7v_profile_lang',
            'tables.ranks' => 'pa7v_ranks',
            'tables.reports' => 'pa7v_reports',
            'tables.reports_reasons' => 'pa7v_reports_reasons',
            'tables.search_results' => 'pa7v_search_results',
            'tables.search_wordlist' => 'pa7v_search_wordlist',
            'tables.search_wordmatch' => 'pa7v_search_wordmatch',
            'tables.sessions' => 'pa7v_sessions',
            'tables.sessions_keys' => 'pa7v_sessions_keys',
            'tables.sitelist' => 'pa7v_sitelist',
            'tables.smilies' => 'pa7v_smilies',
            'tables.sphinx' => 'pa7v_sphinx',
            'tables.styles' => 'pa7v_styles',
            'tables.styles_template' => 'pa7v_styles_template',
            'tables.styles_template_data' => 'pa7v_styles_template_data',
            'tables.styles_theme' => 'pa7v_styles_theme',
            'tables.styles_imageset' => 'pa7v_styles_imageset',
            'tables.styles_imageset_data' => 'pa7v_styles_imageset_data',
            'tables.teampage' => 'pa7v_teampage',
            'tables.topics' => 'pa7v_topics',
            'tables.topics_posted' => 'pa7v_topics_posted',
            'tables.topics_track' => 'pa7v_topics_track',
            'tables.topics_watch' => 'pa7v_topics_watch',
            'tables.user_group' => 'pa7v_user_group',
            'tables.user_notifications' => 'pa7v_user_notifications',
            'tables.users' => 'pa7v_users',
            'tables.warnings' => 'pa7v_warnings',
            'tables.words' => 'pa7v_words',
            'tables.zebra' => 'pa7v_zebra',
            ...
            'tables' => [
                'acl_groups' => 'pa7v_acl_groups',
                'acl_options' => 'pa7v_acl_options',
                'acl_roles' => 'pa7v_acl_roles',
                'acl_roles_data' => 'pa7v_acl_roles_data',
                'acl_users' => 'pa7v_acl_users',
                'attachments' => 'pa7v_attachments',
                'auth_provider_oauth_token_storage' => 'pa7v_oauth_tokens',
                'auth_provider_oauth_states' => 'pa7v_oauth_states',
                'auth_provider_oauth_account_assoc' => 'pa7v_oauth_accounts',
                'banlist' => 'pa7v_banlist',
                'bbcodes' => 'pa7v_bbcodes',
                'bookmarks' => 'pa7v_bookmarks',
                'bots' => 'pa7v_bots',
                'captcha_qa_questions' => 'pa7v_captcha_questions',
                'captcha_qa_answers' => 'pa7v_captcha_answers',
                'captcha_qa_confirm' => 'pa7v_qa_confirm',
                'config' => 'pa7v_config',
                'config_text' => 'pa7v_config_text',
                'confirm' => 'pa7v_confirm',
                'disallow' => 'pa7v_disallow',
                'drafts' => 'pa7v_drafts',
                'ext' => 'pa7v_ext',
                'extensions' => 'pa7v_extensions',
                'extension_groups' => 'pa7v_extension_groups',
                'forums' => 'pa7v_forums',
                'forums_access' => 'pa7v_forums_access',
                'forums_track' => 'pa7v_forums_track',
                'forums_watch' => 'pa7v_forums_watch',
                'groups' => 'pa7v_groups',
                'icons' => 'pa7v_icons',
                'lang' => 'pa7v_lang',
                'log' => 'pa7v_log',
                'login_attempts' => 'pa7v_login_attempts',
                'migrations' => 'pa7v_migrations',
                'moderator_cache' => 'pa7v_moderator_cache',
                'modules' => 'pa7v_modules',
                'notification_emails' => 'pa7v_notification_emails',
                'notification_types' => 'pa7v_notification_types',
                'notifications' => 'pa7v_notifications',
                'poll_options' => 'pa7v_poll_options',
                'poll_votes' => 'pa7v_poll_votes',
                'posts' => 'pa7v_posts',
                'privmsgs' => 'pa7v_privmsgs',
                'privmsgs_folder' => 'pa7v_privmsgs_folder',
                'privmsgs_rules' => 'pa7v_privmsgs_rules',
                'privmsgs_to' => 'pa7v_privmsgs_to',
                'profile_fields' => 'pa7v_profile_fields',
                'profile_fields_data' => 'pa7v_profile_fields_data',
                'profile_fields_options_language' => 'pa7v_profile_fields_lang',
                'profile_fields_language' => 'pa7v_profile_lang',
                'ranks' => 'pa7v_ranks',
                'reports' => 'pa7v_reports',
                'reports_reasons' => 'pa7v_reports_reasons',
                'search_results' => 'pa7v_search_results',
                'search_wordlist' => 'pa7v_search_wordlist',
                'search_wordmatch' => 'pa7v_search_wordmatch',
                'sessions' => 'pa7v_sessions',
                'sessions_keys' => 'pa7v_sessions_keys',
                'sitelist' => 'pa7v_sitelist',
                'smilies' => 'pa7v_smilies',
                'sphinx' => 'pa7v_sphinx',
                'styles' => 'pa7v_styles',
                'styles_template' => 'pa7v_styles_template',
                'styles_template_data' => 'pa7v_styles_template_data',
                'styles_theme' => 'pa7v_styles_theme',
                'styles_imageset' => 'pa7v_styles_imageset',
                'styles_imageset_data' => 'pa7v_styles_imageset_data',
                'teampage' => 'pa7v_teampage',
                'topics' => 'pa7v_topics',
                'topics_posted' => 'pa7v_topics_posted',
                'topics_track' => 'pa7v_topics_track',
                'topics_watch' => 'pa7v_topics_watch',
                'user_group' => 'pa7v_user_group',
                'user_notifications' => 'pa7v_user_notifications',
                'users' => 'pa7v_users',
                'warnings' => 'pa7v_warnings',
                'words' => 'pa7v_words',
                'zebra' => 'pa7v_zebra',
            ],
            'core.adm_relative_path' => 'adm/',
            'core.table_prefix' => 'pa7v_',
